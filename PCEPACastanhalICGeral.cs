...
{
    public partial class PCEPACastanhalICGeralForm : Form
    {
        ...
        public PCEPACastanhalICGeralForm(IConfigurationRoot configuration, HttpClient _httpClient)
        {
        ...
        private List<OrbisDocKeywordVersion> GetOrbisDocKeywordVersionsList(string modalidadeICGeral, string nome, double? ano)
        {
            var keywordVersionList = new List<OrbisDocKeywordVersion>();

            var modalidadeICGeralKeyword = new OrbisDocKeywordVersion
            {
                KeywordTypeOf = "0199814b-d7b5-7cc0-b85a-0a0460021d66",
                Enable = 1,
                Status = 1,
                Value = modalidadeICGeral
            };            
            var nomeKeyword = new OrbisDocKeywordVersion
            {
                KeywordTypeOf = "0199814b-d7b5-7861-8114-fbc6db256b52",
                Enable = 1,
                Status = 1,
                Value = nome
            };
            ...
            {
                KeywordTypeOf = "0199814b-d7b5-74e5-b14a-b774baa35038",
                Enable = 1,
                Status = 1,
                Value = ano is null ? String.Empty : ((int)ano!).ToString()
            };

            keywordVersionList.Add(modalidadeICGeralKeyword);
            ...
            try
            {
                ...
                foreach (string filePath in listFilePaths.Items)
                {
                    if (fileCounter < (int)maxFilesAsDouble)
                    {
                        ...
                        // Tipo documental: PCEPA CASTANHAL - IC GERAL
                        var typeOf = "01998146-6cdd-7ca2-9757-822c43cc694a";
