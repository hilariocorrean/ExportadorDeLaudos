...
{
    partial class CoordenacaoDePericiasNoMortoLaudosForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            Name = "CoordenacaoDePericiasNoMortoLaudosForm";
            Text = "Importador de Laudos - Coordenação de Perícias no Morto (CPM) Laudos";
