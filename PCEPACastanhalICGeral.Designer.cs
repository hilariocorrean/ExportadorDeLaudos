...
{
    partial class PCEPACastanhalICGeralForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // comboReportType
            // 
            comboReportType.Items.AddRange(new object[] { "AMBIENTAL", "BALÍSTICA", "ENGENHARIA", "GRAFOTÉCNICO", "LABORATÓRIO", "LOCAL DE CRIME - CCV", "ODONTO LEGAL", "PERÍCIAS NÃO LOCALIZADAS", "REPRODUÇÃO REALIZADAS", "VEÍCULOS" });
            ...
            labelReportType.Location = new Point(24, 399);
            labelReportType.Name = "labelReportType";
            labelReportType.Size = new Size(156, 20);
            labelReportType.TabIndex = 6;
            labelReportType.Text = "Modalidade (IC Geral)";
            // 
            // labelYear
            // 
            ...
            noYear.Location = new Point(467, 427);
            noYear.Name = "noYear";
            ...
            Name = "PCEPACastanhalICGeralForm";
            Text = "Importador de Laudos - PCEPA Castanhal - IC Geral";
