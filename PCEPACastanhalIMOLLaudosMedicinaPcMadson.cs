...
{
    public partial class PCEPACastanhalIMOLLaudosMedicinaPcMadsonForm : Form
    {
        ...
        public PCEPACastanhalIMOLLaudosMedicinaPcMadsonForm(IConfigurationRoot configuration, HttpClient _httpClient)
        {
        ...
        private List<OrbisDocKeywordVersion> GetOrbisDocKeywordVersionsList(string modalidadeIMOLLaudosMedicina, string nome, double? ano)
        {
            ...
            {
                KeywordTypeOf = "019b1000-0197-7ea0-9768-c1c157b164aa",
                Enable = 1,
                Status = 1,
            ...
            {
                KeywordTypeOf = "019b1000-0197-7738-bae3-596d2678531e",
                Enable = 1,
                Status = 1,
                Value = nome
            };
            ...
            {
                KeywordTypeOf = "019b1000-0197-72e5-9aec-a48682ba834e",
                Enable = 1,
                Status = 1,
            ...
            try
            {
                ...
                foreach (string filePath in listFilePaths.Items)
                {
                    if (fileCounter < (int)maxFilesAsDouble)
                    {
                        ...
                        // Tipo documental: PCEPA CASTANHAL (IMOL) LAUDOS MEDICINA - PC MADSON
                        var typeOf = "019b0ffc-f8c4-7984-a782-b7c5aed1ddc4";
