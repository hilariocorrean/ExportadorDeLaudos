...
{
    public partial class PCEPACastanhalIMOLLaudosMedicinaForm : Form
    {
        ...
        public PCEPACastanhalIMOLLaudosMedicinaForm(IConfigurationRoot configuration, HttpClient _httpClient)
        {
        ...
        private List<OrbisDocKeywordVersion> GetOrbisDocKeywordVersionsList(string modalidadeIMOLLaudosMedicina, string nome, double? ano)
        {
            ...
            {
                KeywordTypeOf = "01998165-54e6-791f-9ffb-77f677dddff1",
                Enable = 1,
                Status = 1,
            ...
            try
            {
                ...
                foreach (string filePath in listFilePaths.Items)
                {
                    if (fileCounter < (int)maxFilesAsDouble)
                    {
                        ...
                        // Tipo documental: PCEPA CASTANHAL (IMOL) LAUDOS MEDICINA
                        var typeOf = "01998162-df00-78c9-824e-685dca82653b";
