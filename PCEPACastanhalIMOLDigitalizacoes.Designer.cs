...
{
    partial class PCEPACastanhalIMOLDigitalizacoesForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // comboReportType
            // 
            comboReportType.Items.AddRange(new object[] { "IGNORADOS - CO E GS", "IGNORADOS NÃO REGISTRADOS", "OUTROS DOCUMENTOS", "PDF SAM", "SEXOLOGIA", "TANATOLOGIA", "TRAUMATOLOGIA" });
            comboReportType.Location = new Point(248, 396);
            ...
            // year
            // 
            year.Location = new Point(248, 426);
            ...
            // maxFiles
            // 
            maxFiles.Location = new Point(248, 456);
            ...
            labelReportType.Size = new Size(231, 20);
            labelReportType.TabIndex = 6;
            labelReportType.Text = "Modalidade (IMOL) Digitalização";
            // 
            // labelYear
            // 
            labelYear.AutoSize = true;
            labelYear.Location = new Point(206, 426);
            ...
            labelMaxFiles.Location = new Point(77, 456);
            ...
            noYear.Location = new Point(529, 429);
            noYear.Name = "noYear";
            noYear.Size = new Size(89, 24);
            noYear.TabIndex = 9;
            noYear.Text = "Sem ano";
            noYear.UseVisualStyleBackColor = true;
            noYear.CheckedChanged += NoYear_CheckedChanged;
            // 
            // PCEPACastanhalIMOLDigitalizacoesForm
            // 
            ...
            Name = "PCEPACastanhalIMOLDigitalizacoesForm";
            Text = "Importador de Laudos - PCEPA Castanhal (IMOL) Digitalizções";
