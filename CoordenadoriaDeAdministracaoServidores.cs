    ...
    public partial class CoordenadoriaDeAdministracaoServidoresForm : Form
    {
        ...
        private void ButtonSelectFolder_Click(object sender, EventArgs e)
        {
            if (folderBrowserDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                // Espera-se que n„o existam arquivos com apenas nome e lixo, pois o lixo tem grandes chances de ser indistinguÌvel.
                Regex nameAndCpfPattern = new Regex(@"^[a-zA-Z·¡È…ÌÕÛ”˙⁄‡¿Ë»ÏÃÚ“˘Ÿ‚¬Í ÓŒÙ‘˚€„√ı’Á«'\s]*\s\d{11}\.pdf$", RegexOptions.Compiled);
                Regex namePattern = new Regex(@"^[a-zA-Z·¡È…ÌÕÛ”˙⁄‡¿Ë»ÏÃÚ“˘Ÿ‚¬Í ÓŒÙ‘˚€„√ı’Á«'\s]*\.pdf$", RegexOptions.Compiled);
                Regex nameCpfAndTimestampPattern = new Regex(@"^[a-zA-Z·¡È…ÌÕÛ”˙⁄‡¿Ë»ÏÃÚ“˘Ÿ‚¬Í ÓŒÙ‘˚€„√ı’Á«'\s]*\s\d{28}\.pdf$", RegexOptions.Compiled);
                Regex nameAndTimestampPattern = new Regex(@"^[a-zA-Z·¡È…ÌÕÛ”˙⁄‡¿Ë»ÏÃÚ“˘Ÿ‚¬Í ÓŒÙ‘˚€„√ı’Á«'\s]*\d{17}\.pdf$", RegexOptions.Compiled);
